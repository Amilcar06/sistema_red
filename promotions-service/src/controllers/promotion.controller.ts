...
class PromotionController {
  ...
  launch = catchAsync(async (req: AuthRequest, res: Response) => {
    const { canal, plantillaMensaje } = req.body;
    const result = await promotionService.launch(req.params.id, canal, plantillaMensaje);
    res.json({
      status: 'success',
      data: result,
